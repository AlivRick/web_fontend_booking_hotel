...
import { registerRental } from "../utils/ApiFunction"; // Giữ lại phương thức gọi API đã thay đổi
...
const RentalRegistration = () => {
  ...
  const handleRegistration = async (e) => {
    e.preventDefault();
    try {
      const result = await registerRental(rentalData); // Gọi phương thức đăng ký rental
      setSuccessMessage(result);
      setErrorMessage("");
      setRentalData({ firstName: "", lastName: "", email: "", password: "" });
    } catch (error) {
      setSuccessMessage("");
